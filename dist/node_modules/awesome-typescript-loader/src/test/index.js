...
describe('main test', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.cleanAndCompile(utils_1.createConfig(config))];
                    case 1:
                        stats = _a.sent();
                        console.log(stats.compilation.errors);
                        utils_1.expect(stats.compilation.errors.length).eq(0);
                        return [4 /*yield*/, utils_1.readOutputFile()];
                    case 2:
                        result = _a.sent();
                        return [4 /*yield*/, utils_1.readFixture(['basic', 'basic.js'])];
                    case 3:
                        expectation = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.cleanAndCompile(utils_1.createConfig(config, { loaderQuery: loaderQuery }))];
                    case 1:
                        stats = _a.sent();
                        utils_1.expect(stats.compilation.errors.length).eq(0);
                        return [2 /*return*/];
    ...
    it('should load tsx files and use tsconfig', function () {
        return __awaiter(this, void 0, void 0, function () {
            var configFileName, config, loaderQuery, stats, result, expectation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        configFileName = utils_1.fixturePath(['tsx', 'tsconfig.json']);
                        config = {
                        ...
                        loaderQuery = { configFileName: configFileName, configFileContent: null };
                        return [4 /*yield*/, utils_1.cleanAndCompile(utils_1.createConfig(config, { loaderQuery: loaderQuery }))];
                    case 1:
                        stats = _a.sent();
                        console.log(stats.compilation.errors);
