...
var DynamicDropDownComponent = (function () {
    ...
    Object.defineProperty(DynamicDropDownComponent.prototype, "isValid", {
        get: function () {
            return this.form.controls[this.dynamicDisc.key].valid;
        },
        enumerable: true,
        configurable: true
    });
...
], DynamicDropDownComponent.prototype, "dynamicDisc", void 0);
__decorate([
    core_1.Input(),
...
DynamicDropDownComponent = __decorate([
    core_1.Component({
        ...
        templateUrl: "../../View/dynamicForm/DynamicDropDownComponent.html"
    }),
